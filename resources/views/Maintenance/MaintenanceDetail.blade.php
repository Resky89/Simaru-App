                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex flex-col">
                                    ...
                                    <span class="font-medium">{{ isset($maintenance['maintenance_report']['maintenance_date']) ? date('d F Y H:i', strtotime($maintenance['maintenance_report']['maintenance_date'])) : 'N/A' }}</span>
                                </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex flex-col">
                                    ...
                                    <p class="whitespace-pre-wrap">{{ $maintenance['maintenance_report']['description'] ?? 'Tidak ada deskripsi tersedia' }}</p>
                                </div>
                            </div>
                        </div>
