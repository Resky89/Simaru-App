...
@section('content')
    ...
    @if(hasPermission('complaint:create'))
        <x-modal id="createComplaintModal" title="BUAT KELUHAN" maxWidth="sm:max-w-[700px]">
    ...
    @if(hasPermission('complaint:delete'))
        <x-modal id="deleteComplaintModal" title="Hapus Keluhan">
    ...
    @if(hasPermission('repair:medical') || hasPermission('repair:non-medical'))
        <x-modal id="repairComplaintModal" title="LAKUKAN PERBAIKAN" maxWidth="sm:max-w-[800px]">
