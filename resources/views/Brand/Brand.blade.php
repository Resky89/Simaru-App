                    ...
                    @csrf
                        <div class="space-y-4 max-w-[400px] mx-auto">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="invalid-feedback text-red-500 text-sm mt-1 hidden">Nama Merk harus diisi</div>
                            </div>
                ...
                <div class="p-6">
                    <div class="space-y-6 max-w-[400px] mx-auto">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-base text-gray-600 text-center">Apakah Anda yakin ingin menghapus merk: <span id="delete_brand_name" class="font-bold"></span>? Tindakan ini tidak dapat dibatalkan.</p>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="text-gray-600 text-sm bg-blue-50 p-4 rounded-lg">
                                ...
                                <div class="mt-3 flex justify-end">
                                    <a href="{{ asset('docs/ImportBrandTemplate.xlsx') }}" download class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-[#213268] rounded-md hover:bg-[#152451] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="border-2 border-dashed border-[#213268] rounded-lg p-6 relative flex flex-col items-center justify-center bg-blue-50 hover:bg-blue-100 transition-colors duration-200">
                                    ...
                                    <div id="brand-excel-file-name" class="mt-2 mb-4 w-full hidden">
                                        <div class="bg-white p-2 rounded border border-gray-300 w-full max-w-md mx-auto">
                                            <div class="flex items-center">
                                                ...
                                                <span id="brand-file-name-text" class="text-sm text-gray-700 truncate"></span>
                                                <button type="button" id="remove-brand-excel" class="ml-auto text-red-500 hover:text-red-700">
                                    ...
                                    <input type="file" id="brand_excel_file" name="excel_file" accept=".xlsx,.xls,.csv" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <button type="button" id="brand-preview-btn" disabled class="w-1/2 h-[45px] bg-[#213268] text-white rounded-lg text-base hover:bg-[#152451] transform active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                                    Pratinjau Data
                                </button>
                            </div>
                        </div>
                ...
                <div id="import-brand-step-2" class="hidden">
                    <div class="p-6">
                        <div class="space-y-6">
                            ...
                            <div id="brand-preview-warnings" class="hidden text-yellow-600 text-sm bg-yellow-50 p-4 rounded-lg">
                            ...
                            <!-- Action Buttons -->
                            <div class="flex gap-3">
                                <button type="button" id="brand-back-to-upload-btn" class="w-1/3 h-[45px] bg-gray-200 text-gray-800 rounded-lg text-base hover:bg-gray-300 transform active:scale-[0.98] transition-all duration-200">
                                    Kembali
                                </button>
                                <form action="{{ route('brands.import') }}" method="POST" id="brand-import-form" class="w-2/3" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="excel_data" id="brand_excel_data">
                                    <button type="submit" id="brand-import-btn" class="w-full h-[45px] bg-green-600 text-white rounded-lg text-base hover:bg-green-700 transform active:scale-[0.98] transition-all duration-200">
                                        Import Data
                                    </button>
                                </form>
                            </div>
