                        ...
                        <div class="flex flex-col space-y-1">
                            ...
                            @php
                                ...
                                if (isset($calibration['location'])) {
                                    $locationParts = [];
                                    if (!empty($calibration['location']['room_name']))
                                        $locationParts[] = $calibration['location']['room_name'];
                                    if (!empty($calibration['location']['floor_number']))
                                        $locationParts[] = $calibration['location']['floor_number'];
                                    if (!empty($calibration['location']['building_name']))
                                        $locationParts[] = $calibration['location']['building_name'];
                        ...
                        @if(isset($calibration['actual_calibration_date']) && $calibration['actual_calibration_date'])
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <div>
                                    ...
                                    @else
                                        <span
                                            class="font-medium">{{ isset($calibration['calibration_result']) ? ucfirst($calibration['calibration_result']) : 'N/A' }}</span>
                                    @endif
                                </div>
                            </div>
                        @endif
