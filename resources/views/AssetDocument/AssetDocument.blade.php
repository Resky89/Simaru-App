                                ...
                                <tr data-document-id="{{ $document['document_id'] ?? '' }}">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('document.view', $document['document_id']) }}" class="p-2 bg-[#D5E1F7] text-[#213268] rounded-md hover:bg-blue-200 transition-colors" title="Lihat Dokumen">
...
<!-- Add Document Modal -->
@if(hasPermission('document:create'))
<x-modal id="addDocumentModal" title="TAMBAH DOKUMEN BARU" maxWidth="sm:max-w-[700px]">
                            ...
                            <div>
                                ...
                                <div class="border-2 border-dashed border-[#213268] rounded-lg p-6 relative flex flex-col items-center justify-center bg-blue-50 hover:bg-blue-100 transition-colors duration-200">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">Format yang diterima: PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG (Ukuran maks: 10MB)</p>
...
@if(hasPermission('document:delete'))
<x-modal id="deleteModal" title="HAPUS DOKUMEN">
...
<!-- Edit Document Modal -->
@if(hasPermission('document:edit'))
    <x-modal id="editDocumentModal" title="UBAH DOKUMEN" maxWidth="sm:max-w-[700px]">
