...
<body>
            ...
            <div class="section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">{{ isset($purchaseOrder['created_at']) ? date('d M Y', strtotime($purchaseOrder['created_at'])) : 'N/A' }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        Sistem Monitoring Aset - Laporan Pemesanan - {{ date('Y') }}
    </div>
</body>
</html>
