        ...
        <div class="card-body p-4 md:p-7">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <h1 class="text-2xl md:text-[32px] font-semibold text-[#213268]">RECEIPT</h1>

                    <div class="flex gap-3">
                        <!-- Add Receipt Button -->
                        <a href="{{ route('procurement.form-receipt') }}" class="flex items-center justify-center gap-2 px-3 py-3 bg-[#213268] rounded-lg text-white hover:bg-[#152451]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                            </svg>
                            <span class="text-base">Add Receipt</span>
                        </a>
                    </div>
                </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Receipt Number</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">PO ID</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Vendor</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Delivered by</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Received by</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Receipt Date</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="p-3 border-t border-[#EEF1F4] text-center">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="{{ route('procurement.detail-receipt', 1) }}" class="text-[#3D3D3D] hover:text-[#213268]">
                            ...
                            <tr>
                                ...
                                <td class="p-3 border-t border-[#EEF1F4] text-center">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="{{ route('procurement.detail-receipt', 2) }}" class="text-[#3D3D3D] hover:text-[#213268]">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                            </svg>
