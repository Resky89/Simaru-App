                    ...
                    <form id="createVendorForm" action="{{ route('vendor.store') }}" method="POST" novalidate>
                        ...
                        <div class="space-y-4 max-w-[400px] mx-auto">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="error-message text-red-500 text-sm mt-1 hidden">Nama Vendor harus diisi</div>
                            </div>
                ...
                <div class="p-6">
                    <div class="space-y-6 max-w-[400px] mx-auto">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-base text-gray-600 text-center">Apakah Anda yakin ingin menghapus vendor ini? Tindakan ini tidak dapat dibatalkan.</p>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="border-2 border-dashed border-[#213268] rounded-lg p-6 relative flex flex-col items-center justify-center bg-blue-50 hover:bg-blue-100 transition-colors duration-200">
                                    ...
                                    <div id="vendor-excel-file-name" class="mt-2 mb-4 w-full hidden">
                                        <div class="bg-white p-2 rounded border border-gray-300 w-full max-w-md mx-auto">
                                            <div class="flex items-center">
                                                ...
                                                <span id="vendor-file-name-text" class="text-sm text-gray-700 truncate"></span>
                                                <button type="button" id="remove-vendor-excel" class="ml-auto text-red-500 hover:text-red-700">
                                    ...
                                    <input type="file" id="vendor_excel_file" name="excel_file" accept=".xlsx,.xls,.csv" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <button type="button" id="vendor-preview-btn" disabled class="w-1/2 h-[45px] bg-[#213268] text-white rounded-lg text-base hover:bg-[#152451] transform active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                                    Pratinjau Data
                                </button>
                            </div>
                        </div>
                ...
                <div id="import-vendor-step-2" class="hidden">
                    <div class="p-6">
                        <div class="space-y-6">
                            ...
                            <div id="vendor-preview-warnings" class="hidden text-yellow-600 text-sm bg-yellow-50 p-4 rounded-lg">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function closeModal(modal, content) {
            ...
            setTimeout(() => {
                ...
                // Reset import vendor modal when closed
        ...
        function applyFilters() {
            ...
            // Clear existing search and sort parameters we're going to set
            ...
            // Keep other parameters (like limit)
        ...
        // File input handling for vendors
            ...
            vendorPreviewBtn.addEventListener('click', function() {
                ...
                reader.onload = function(e) {
                    try {
                        ...
                        // Process the Excel data for vendors
        ...
        // Function to process Excel data for vendors
        ...
        // Function to show data preview for vendors
