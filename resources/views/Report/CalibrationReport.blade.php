        ...
        <div class="card-body p-4 md:p-7">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <h1 class="text-2xl md:text-[32px] font-semibold text-[#213268]">CALIBRATION REPORT</h1>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Asset ID</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Certificate Number</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Calibration Date</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Perform by</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Vendor</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Assistance</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Result</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Is passed</th>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add click event for the Export PDF button
        exportBtn.addEventListener('click', () => {
            // Code to handle PDF export functionality
        ...
        // Add click events for More buttons
        moreBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                // Code to handle more options functionality
