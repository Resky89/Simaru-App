        ...
        <div class="card-body p-4 md:p-7">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <h1 class="text-2xl md:text-[32px] font-semibold text-[#213268]">COMPLAIN REPORT</h1>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Person</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Complain Date</th>
