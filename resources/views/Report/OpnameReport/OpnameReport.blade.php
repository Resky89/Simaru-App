                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-3 text-xs border-t border-[#EEF1F4]">
                                    <div class="flex items-center space-x-2 justify-center">
                                        <a href="{{ route('opnames.detail', $opname['opname_id']) }}" class="p-2 bg-[#D5E1F7] text-[#213268] rounded-md hover:bg-blue-200 transition-colors">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="p-3 text-xs border-t border-[#EEF1F4] text-center">Tidak ada laporan opname ditemukan</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
