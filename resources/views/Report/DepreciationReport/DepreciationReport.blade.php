            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                                <input type="text" id="building_search" class="w-full border border-[#D8DAE5] rounded-md py-2 px-3 text-[#213268] focus:outline-none focus:border-[#213268] focus:ring focus:ring-[#213268] focus:ring-opacity-20" placeholder="Search building" autocomplete="off">
                                ...
                                <div id="building_dropdown" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm hidden">
                                    ...
                                    <div id="building_loading" class="flex justify-center py-2">
                                        ...
                                        <span class="ml-2 text-gray-600">Loading buildings...</span>
                                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                                <input type="text" id="room_search" class="w-full border border-[#D8DAE5] rounded-md py-2 px-3 text-[#213268] focus:outline-none focus:border-[#213268] focus:ring focus:ring-[#213268] focus:ring-opacity-20" placeholder="Select building first" autocomplete="off" disabled>
                                ...
                                <div id="room_dropdown" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm hidden">
                                    ...
                                    <div id="room_loading" class="flex justify-center py-2">
                                        <div class="animate-spin rounded-full h-5 w-5 border-b-2 border-[#213268]"></div>
                                        <span class="ml-2 text-gray-600">Loading rooms...</span>
                                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                                <select name="asset_type" class="w-full border border-[#D8DAE5] rounded-md py-2 px-3 pr-8 appearance-none text-[#213268]">
                                    ...
                                    <option value="medical" {{ $asset_type == 'medical' ? 'selected' : '' }}>Medical</option>
                                    <option value="non_medical" {{ $asset_type == 'non_medical' ? 'selected' : '' }}>Non Medical</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                                <input type="text" id="subcategory_search" class="w-full border border-[#D8DAE5] rounded-md py-2 px-3 text-[#213268] focus:outline-none focus:border-[#213268] focus:ring focus:ring-[#213268] focus:ring-opacity-20" placeholder="Select asset type first" autocomplete="off" disabled>
                    ...
                    <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Search Asset Master</label>
                            <div class="relative">
                                <input type="text" id="asset_master_search" class="w-full border border-[#D8DAE5] rounded-md py-2 px-3 text-[#213268] focus:outline-none focus:border-[#213268] focus:ring focus:ring-[#213268] focus:ring-opacity-20" placeholder="Search by asset master name" autocomplete="off">
                                ...
                                <div id="asset_master_dropdown" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm hidden">
                                    ...
                                    <div id="asset_master_loading" class="flex justify-center py-2">
                                        <div class="animate-spin rounded-full h-5 w-5 border-b-2 border-[#213268]"></div>
                                        <span class="ml-2 text-gray-600">Searching asset masters...</span>
                                    </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-right">Purchase Cost</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-right">Salvage Value</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-center">Asset Life (Month)</th>
                        ...
                        <tbody>
                            @if(isset($items) && count($items) > 0)
                                ...
                                <tr>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4] text-center">{{ $item['asset_id'] }}</td>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4]">{{ $item['asset_name'] }}</td>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4]">{{ \Carbon\Carbon::parse($item['date_acquired'])->format('d M Y') }}</td>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4] text-right">Rp {{ number_format($item['purchase_cost'], 0, ',', '.') }}</td>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4] text-right">Rp {{ number_format($item['salvage_value'], 0, ',', '.') }}</td>
                                    ...
                                    <td class="p-3 text-xs border-t border-[#EEF1F4]">{{ $item['month_and_year'] }}</td>
                                    <td class="p-3 text-xs border-t border-[#EEF1F4] text-right">Rp {{ number_format($item['book_value_at_month_end'], 0, ',', '.') }}</td>
                            ...
                            @elseif(!isset($error))
                                <tr>
                                    <td colspan="13" class="p-3 text-xs border-t border-[#EEF1F4] text-center">No depreciation data found.</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mt-4">
                    ...
                    <div class="relative mt-4 md:mt-0">
                        <select name="limit" form="depreciationFilterForm" onchange="document.getElementById('depreciationFilterForm').submit()" class="border border-[#D8DAE5] rounded-md py-1 px-3 pr-8 appearance-none text-[#213268] text-sm">
                            ...
                            <option value="100" {{ ($pagination['per_page'] ?? 10) == 100 ? 'selected' : '' }}>100 per page</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-[#213268]">
                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M7 7l3-3 3 3m0 6l-3 3-3-3" />
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (assetTypeSelect && subcategorySearch) {
            ...
            assetTypeSelect.addEventListener('change', function() {
                if (this.value) {
                    ...
                    subcategorySearch.placeholder = 'Select asset type first';
                    subcategorySearch.value = '';
                    selectedSubcategory.value = '';
                }
            });
            ...
            async function loadSubcategories(searchTerm, assetType) {
                ...
                loadingItem.innerHTML = `
                    <div class="animate-spin rounded-full h-5 w-5 border-b-2 border-[#213268]"></div>
                    <span class="ml-2 text-gray-600">Loading subcategories...</span>
                `;
                ...
                try {
                    ...
                    if (subcategories.length === 0) {
                        ...
                        noResults.textContent = 'No subcategories found';
                        ...
                        if (searchTerm) {
                            subcategories.forEach(item => {
                                const subcategoryName = item.subcategory_name || 'Unknown';
                        ...
                        if (subcategories.length > 10) {
                            ...
                            countItem.textContent = `Showing ${Math.min(subcategories.length, 50)} of ${subcategories.length} subcategories`;
                    ...
                    errorItem.textContent = `Error loading subcategories: ${error.message}`;
                    ...
                    if (searchTerm) {
                        ...
                        manualOption.textContent = `➕ Use "${searchTerm}" as subcategory`;
                    ...
                    subcategorySearch.placeholder = "Error loading subcategories";
                }
            }
        ...
        function initBuildingSearch() {
            ...
            const showError = (message) => {
                const errorItem = document.createElement('li');
                errorItem.className = 'px-4 py-2 text-red-500';
                errorItem.textContent = message || 'Error loading buildings';
                buildingList.innerHTML = '';
                buildingList.appendChild(errorItem);

                // Also update the input placeholder to indicate the error
                searchInput.placeholder = "Error loading buildings";
            };
        ...
        function initRoomSearch() {
            ...
            const showError = (message) => {
                const errorItem = document.createElement('li');
                errorItem.className = 'px-4 py-2 text-red-500';
                errorItem.textContent = message || 'Error loading rooms';
                roomList.innerHTML = '';
                roomList.appendChild(errorItem);

                // Also update the input placeholder to indicate the error
                searchInput.placeholder = "Error loading rooms";
            };
            ...
            const addFallbackOption = () => {
                ...
                fallbackOption.textContent = '➕ Use current input as room name';
            ...
            async function loadRooms(searchTerm, buildingId) {
                ...
                try {
                    ...
                    if (rooms.length === 0) {
                        const noResults = document.createElement('li');
                        noResults.className = 'px-4 py-2 text-gray-500 italic';
                        noResults.textContent = 'No rooms found for this building';
                        ...
                        rooms.forEach(item => {
                            ...
                            const roomName = item.room_name || 'Unknown';
        ...
        function initAssetMasterSearch() {
            ...
            const showError = (message) => {
                const errorItem = document.createElement('li');
                errorItem.className = 'px-4 py-2 text-red-500';
                errorItem.textContent = message || 'Error loading asset masters';
                assetList.innerHTML = '';
                assetList.appendChild(errorItem);

                // Also update the input placeholder to indicate the error
                searchInput.placeholder = "Error loading asset masters";
            };
