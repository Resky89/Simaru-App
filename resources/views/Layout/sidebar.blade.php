    ...
    <div class="flex flex-col gap-[5px] mt-5">
        ...
        <div class="h-[52px] w-full bg-white">
            <a href="{{ route('dashboard') }}" class="block">
                <div class="mx-[13px] h-[41px] mt-[5px] rounded-[8px] flex items-center transition-all duration-300 ease-in-out hover:bg-[#56C5F1]/20 {{ Request::routeIs('dashboard') ? 'bg-[#56C5F1]/20' : '' }}">
        ...
        <div class="w-full bg-white">
            <button @click="activeMenu = (activeMenu === 'procurement') ? null : 'procurement'" class="w-full">
                <div class="mx-[13px] h-[41px] mt-[5px] rounded-[8px] flex items-center transition-all duration-300 ease-in-out hover:bg-[#56C5F1]/20">
                    <div class="w-6 h-6 ml-5">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#757575">
        ...
        <!-- Report -->
        <div class="w-full bg-white">
            <button @click="activeMenu = (activeMenu === 'report') ? null : 'report'" class="w-full">
                <div class="mx-[13px] h-[41px] mt-[5px] rounded-[8px] flex items-center transition-all duration-300 ease-in-out hover:bg-[#56C5F1]/20">
                    <div class="w-6 h-6 ml-5">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="#757575">
