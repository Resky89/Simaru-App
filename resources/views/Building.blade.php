...
@section('content')
    ...
    <div class="h-full space-y-4 md:space-y-6">
        ...
        <!-- Add Building Modal -->
        @if(hasPermission('building:create'))
            <x-modal id="addBuildingModal" title="Tambah Gedung">
        ...
        <!-- Edit Building Modal -->
        @if(hasPermission('building:edit'))
            <x-modal id="editBuildingModal" title="Edit Gedung">
        ...
        @if(hasPermission('building:delete'))
            <x-modal id="deleteBuildingModal" title="Hapus Gedung">
        ...
        @if(hasPermission('building:import'))
            <x-modal id="importBuildingModal" title="IMPOR GEDUNG" maxWidth="sm:max-w-[700px]">
