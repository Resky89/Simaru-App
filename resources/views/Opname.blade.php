                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Room ID</th>
                                ...
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Initiator</th>
                                <th class="bg-[#213268] text-white p-3 font-bold text-xs text-left">Opname Date</th>
