...
<body class="bg-[#ECECEC]">
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        <div class="w-full max-w-4xl relative">
            <!-- Background Blobs -->
            <div class="absolute -top-20 -left-20 w-64 h-64 bg-[#56C5F1]/10 blob -z-10"></div>
                ...
                <div class="flex flex-col md:flex-row">
                        ...
                        <div class="animate-float">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500"
                                ...
                                <text x="140" y="260" font-family="Poppins" font-size="120" font-weight="bold"
                                    fill="#56C5F1">404</text>
                                <circle cx="250" cy="350" r="10" fill="#56C5F1" class="animate-pulse" />
                                <circle cx="290" cy="350" r="10" fill="#56C5F1" class="animate-pulse" />
                                <circle cx="210" cy="350" r="10" fill="#56C5F1" class="animate-pulse" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                        <div class="mb-2 inline-block">
                            <span class="px-3 py-1 bg-[#56C5F1]/20 text-[#213268] rounded-full font-medium">Error
                                404</span>
                        </div>

                        <h1 class="text-4xl font-bold text-[#213268] mb-4">Halaman Tidak Ditemukan</h1>
