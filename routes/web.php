...
Route::middleware([AuthMiddleware::class])->group(function () {
    ...
    // Building Management
    Route::prefix('buildings')->middleware('permission:building:view|room:create|room:edit|asset:checkout|report:depreciation')->group(function () {
    ...
    // Room Management
    Route::prefix('rooms')->middleware('permission:room:view')->group(function () {
    ...
    // Vendor Management
    Route::prefix('vendor')->middleware('permission:vendor:view|maintenance:create|maintenance:edit|calibration:report')->group(function () {
    ...
    // User Management
    Route::prefix('user')->middleware('permission:user:view')->group(function () {
    ...
    // Master Asset routes
    Route::prefix('asset-master')->middleware('permission:asset-master:view')->group(function () {
    ...
    Route::get('/view-asset-master/{id}/edit', [ViewMasterAssetController::class, 'editMasterAsset'])->name('asset-master.edit');
        Route::get('/view-asset-master/{id}/export-pdf', [ViewMasterAssetController::class, 'exportMasterAssetPDF'])
            ->name('export-master-asset-pdf')
            ->middleware('permission:asset-master:export');
    });
    ...
    Route::middleware('permission:asset:view')->group(function() {
        ...
        Route::post('/asset/checkin', [AssetDetailsController::class, 'checkinAsset'])
            ->name('asset.checkin')
            ->middleware('permission:asset:return');
    ...
    Route::middleware('permission:depreciation:view')->group(function() {
    ...
    Route::put('/asset-depreciation/{assetId}', [AssetDepreciationController::class, 'updateAssetDepreciation'])
            ...
            ->middleware('permission:depreciation:edit');
    });
    ...
    Route::middleware('permission:asset_transaction:view')->group(function() {
        // Read operations
        ...
        Route::delete('/asset-transactions/{transactionId}', [AssetFinanceController::class, 'deleteTransaction'])
            ...
            ->middleware('permission:asset_transaction:delete');
    });
    ...
    Route::prefix('procurement')->name('procurement.')->middleware('permission:procurement:view')->group(function () {
        ...
        Route::get('/detail-comparison/{id}', [ProcurementPriceComparisonController::class, 'show'])
            ...
            ->middleware('permission:price-comparison:view');
        Route::get('/price-comparison/data', [ProcurementPriceComparisonController::class, 'index'])
            ->name('price-comparison-data')
            ->middleware('permission:price-comparison:view');
        Route::get('/price-comparison/{id}', [ProcurementPriceComparisonController::class, 'show'])
        ...
        Route::post('/price-comparison/{id}/complete', [ProcurementPriceComparisonController::class, 'completeComparison'])
            ...
            ->middleware('permission:price-comparison:approve');

        // Vendor Offer API
        Route::middleware('permission:price-comparison:edit')->group(function() {
